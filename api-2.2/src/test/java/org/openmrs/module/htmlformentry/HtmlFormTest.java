...
public class HtmlFormTest extends BaseModuleContextSensitiveTest { 
	...
	public void testSingleObsGroupAndEncounterDiagnosesTagsShouldPassGivenNonEmptyObsGroup() throws Exception {
		...
		new RegressionTestHelper() {
			...
			public void setupRequest(MockHttpServletRequest request, Map<String, String> widgets) {
				...
				request.addParameter(widgets.get("Dose:"), "1*3 daily");
			...
			public void testResults(SubmissionResults results) {
				...
				results.assertObsCreated(51, "1*3 daily");
	...
	public void testSingleObsGroupAndEncounterDiagnosesTagsFailsGivenEmptyObsGroup() throws Exception {
		final Date date = new Date();
		new RegressionTestHelper() {
			...
			public void setupRequest(MockHttpServletRequest request, Map<String, String> widgets) {
				...
				request.addParameter(widgets.get("Location:"), "2");
				request.addParameter(widgets.get("Provider:"), "1");
				request.addParameter(widgets.get("Dose:"), ""); // To reproduce the stack trace
				request.addParameter("encounterDiagnoses", "[{\"certainty\":\"PRESUMED\",\"order\":\"PRIMARY\",\"diagnosis\":\"Concept:22\",\"existingObs\":null,\"existingDiagnosis\":null}]");
			}
