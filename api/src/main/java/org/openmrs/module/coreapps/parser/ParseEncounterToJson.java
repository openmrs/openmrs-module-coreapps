...
public class ParseEncounterToJson {
    ...
    public SimpleObject createEncounterJSON(User authenticatedUser, Encounter encounter) {
        ...
        simpleEncounter.put("encounterTime", uiUtils.handleTimeZones() ? uiUtils.formatTimeWithClientTimezone(encounter.getEncounterDatetime()) : DateFormatUtils.format(encounter.getEncounterDatetime(), "hh:mm a", Context.getLocale()));
