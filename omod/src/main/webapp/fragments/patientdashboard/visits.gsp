...
<script type="text/javascript">
    jq(function(){
        ...
        <% } %>
        loadTemplates(visitId, ${ patient.id }, fromEncounter, encounterCount, ${userId}, ${ui.convertTimezones()});
        <%
            if ( activeVisit != null){
        ...
        <li class="menu-item viewVisitDetails" data-visit-id="${wrapper.visit.visitId}">
            <span class="menu-date">
                ...
                <span class="visit-start-date">
                    ${ui.formatDateWithClientTimezone(wrapper.visit.startDatetime)}
                </span>
               <% if(wrapper.stopDate != null) { %>
                   - <span class="visit-stop-date">
                       ${ui.formatDateWithClientTimezone(wrapper.visit.stopDatetime)}
                   </span>
               <% } %>
                <% } else { %>
