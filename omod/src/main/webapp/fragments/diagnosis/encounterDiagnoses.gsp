...
<div id="encounter-diagnoses-app">
    ...
    <div data-ng-controller="DiagnosesController">
        ...
        <div id="diagnosis-search-container">
            ...
            <input id="diagnosis-search" type="text" placeholder="${ ui.message("coreapps.consult.addDiagnosis.placeholder") }" autocomplete itemFormatter="autocomplete-render-item" diagnosisSetUuids="${ config.diagnosisSetUuids }"/>
