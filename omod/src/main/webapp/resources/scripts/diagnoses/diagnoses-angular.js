    ...
    .directive('autocomplete', function($compile) {
        return function(scope, element, attrs) {
            ...
            element.autocomplete({
                source: emr.fragmentActionLink("coreapps", "diagnoses", "search", {diagnosisSets: attrs.diagnosissets, diagnosisConceptSources: attrs.diagnosisconceptsources, diagnosisConceptClasses: attr.diagnosisconceptclasses}),
