 ...
 *
 */
public class EncounterDiagnosesByObsTagHandlerComponentTest extends BaseModuleWebContextSensitiveTest {

    private EncounterDiagnosesByObsTagHandler encounterDiagnosesTagHandler;
    ...
    public void setUp() throws Exception {
        ...
        encounterDiagnosesTagHandler = CoreAppsActivator.setupEncounterDiagnosesByObsTagHandler(conceptService, adtService, Context.getRegisteredComponent("emrApiProperties", EmrApiProperties.class), null);
